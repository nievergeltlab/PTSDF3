...
dm1$IID_pc <- dm1$IID
 ...
 {
  pcs <-  read.table(paste('/home/pgcdac/DWFV2CJb8Piv_0116_pgc_data/pts/wave3/v1/',tdata,'/covariates/pts_',tdata,'_mix_am-qc-all_pca.menv.mds_cov',sep=''),header=T,stringsAsFactors=F)
